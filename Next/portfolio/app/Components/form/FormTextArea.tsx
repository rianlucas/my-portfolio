...
export default function FormTextArea(props: InputProps) {
  return (
    <div className="flex flex-col px-2 py-2 max-w-sm font-mono w-full">
      ...
      <textarea value={props.Value} onChange={props.onChange} className="text-default-text-color h-[9rem] px-2 bg-[#011121] border border-default-border-color rounded-lg focus:border-2"/>
    </ div>
  )
}